...
with app.app_context():
    ...
    acct_id='ktruong6'
    acct_first_name='Kristy'
    acct_last_name='Truong'
    acct_email='ktruong@umd.edu'
    ...
    users = [
        ...
        {'username':'ktruong6','email':'ktruong6@umd.edu','first_name':'Kristy','last_name':'Truong',
         'password':generate_password_hash('ktruong6',method='pbkdf2:sha256'), 'role':'STUDENT'}
    ]
    ...
    students = [
        ...
        {'first_name': 'Kristy', 'last_name': 'Truong', 'email':'ktruong6@umd.edu',
            'major_id': 1, 'birth_date': dt.strptime('2000-01-01', '%Y-%m-%d'), 'is_honors': 1}
    ]
